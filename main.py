...
parser.add_argument('--save', type=str, default='save/model2.pt', help='path to save the final model')
...
try:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_loss, val_rae, val_corr,val_rmse,val_mae = eval_method(Data, Data.valid[0], Data.valid[1], model, evaluateL2, evaluateL1,
                                                  args)
        ...
        if val_loss < best_val:
            ...
            best_val = val_loss
        if epoch % 10 == 0:
            test_acc, test_rae, test_corr = eval_method(Data, Data.test[0], Data.test[1], model, evaluateL2, evaluateL1,
                                                        args)
